...
- 2026-04-26: Extended Pass 7 in `v=20260426l` to also collapse main-body font-sizes (10pt–12pt → 12pt) while preserving fine print (<10pt) and outliers (>12pt). Reason: typed reply rendered at 12pt while quoted bodies rendered at 11pt — visually inconsistent even after font-family unification. Bounded range avoids the "everything to 12pt" failure that ballooned 8pt confidentiality and 9pt banners. Confirmed by Nick on the same DXP/Premier-flow dry-run before shipping. Test verified 50 sizes collapsed, 8 fine-print sizes (4×9pt + 4×8pt) preserved.
